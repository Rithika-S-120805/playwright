...
**Git Repository:** https://github.com/ravikaanthe/AgentE2EQAWorkflow-Playwright.git
...
- All paths should be treated as relative to the workspace root
- Use code blocks for file paths and commands for clarity
- Replace agent names with actual MCP agent identifiers when executing
- Update placeholder URLs and repository links as needed for your environment
