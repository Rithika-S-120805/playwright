/**
 * Example: Manual GitHub Issue Creation for Test Failures
 * Shows different approaches to creating issues programmatically
 */

import { GitHubIssueManager, FailureInfo } from '../src/utils/github-issue-manager';

/**
 * Example 1: Using GitHubIssueManager directly
 */
async function example1_UsingIssueManager(): Promise<void> {
...
/**
 * Example 2: Using fetch directly (lower level)
 */
async function example2_UsingFetchDirectly(): Promise<void> {
...
/**
 * Example 3: Batch create issues for multiple failures
 */
async function example3_BatchCreateIssues(): Promise<void> {
...
/**
 * Example 4: Search for existing issues before creating
 */
async function example4_SearchExistingIssues(): Promise<void> {
  ...
  try {
    ...
    data.items.forEach((issue: { number: number; title: string; created_at: string }) => {
...
/**
 * Example 5: Add comment to existing issue
 */
async function example5_AddCommentToIssue(): Promise<void> {
...
/**
 * Example 6: Close related issues (when test passes again)
 */
async function example6_CloseIssue(): Promise<void> {
...
/**
 * Example 7: Using axios instead of fetch
 */
async function example7_UsingAxios(): Promise<void> {
  ...
  try {
    ...
    // Axios example (pseudo-code, requires axios installation)
    const axiosExample = `
    import axios from 'axios';
